...
import type { SportBadgeDefinition } from "@/lib/sportLifestyle";
...
export const SportBadgeThumbnail = ({ badge, earned = false, progress, size = "md", className }: SportBadgeThumbnailProps) => {
