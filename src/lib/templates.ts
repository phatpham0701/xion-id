...
// Starter templates align 1:1 with the onboarding `DemoStarterKey` keys.
// They use only existing block types so no DB enum change is required.
const QR_DEMO = "https://api.qrserver.com/v1/create-qr-code/?size=320x320&data=https%3A%2F%2Fxionid.com%2Fyou";

export const TEMPLATES: ProfileTemplate[] = [
  // ────────── STARTERS (Phase 2 — onboarding-aligned) ──────────
  {
    id: "essential-rewards",
    name: "Essential Rewards Passport",
    tagline: "Profile + badges + offers + claimed rewards. Best all-rounder.",
    emoji: "🎫",
    category: "starter",
    theme: t({ background: "aurora", font: "outfit", buttonShape: "rounded", buttonStyle: "glass", accentHue: 200 }),
    blocks: [
      { type: "avatar",  config: { name: "Alex Rivera", subtitle: "@alex · verified identity" } },
      { type: "text",    config: { text: "I collect proof for the things I love. Here's what's open right now." } },
      { type: "heading", config: { text: "Today's offers" } },
      { type: "link",    config: { title: "20% off Nimbus Coffee", url: "https://", emoji: "☕" } },
      { type: "link",    config: { title: "Early access · Lumen Apparel", url: "https://", emoji: "🧥" } },
      { type: "heading", config: { text: "My badges" } },
      { type: "text",    config: { text: "🏅 OG · 🎴 Collector · 🧭 Explorer" } },
      { type: "heading", config: { text: "Claimed rewards" } },
      { type: "link",    config: { title: "Signed digital print", url: "https://", emoji: "🖼️" } },
      { type: "image",   config: { url: QR_DEMO, alt: "Scan my page" } },
    ],
  },
  {
    id: "minimal-public",
    name: "Minimal Public Card",
    tagline: "Avatar, name, short bio, one CTA, selected badges.",
    emoji: "🪪",
    category: "starter",
  ...
  {
    id: "badge-first",
    name: "Badge-First Passport",
    tagline: "Lead with proof — badges, eligibility, recent activity.",
    emoji: "🏅",
    category: "starter",
    theme: t({ background: "midnight", font: "space-grotesk", buttonShape: "rounded", buttonStyle: "glass", accentHue: 215 }),
    blocks: [
      { type: "avatar",  config: { name: "Maya Chen", subtitle: "Collector · Explorer" } },
      { type: "heading", config: { text: "Featured proof" } },
      { type: "text",    config: { text: "🏅 OG 2024 · 🎴 Collector tier 2 · 🧭 Explorer tier 1" } },
      { type: "heading", config: { text: "All badges" } },
      { type: "image",   config: { url: "https://images.unsplash.com/photo-1521120098171-ddc1d3a3a4f7?w=900", alt: "Badge wall" } },
      { type: "heading", config: { text: "Reward eligibility" } },
      { type: "link",    config: { title: "View what I can unlock", url: "https://", emoji: "🎁" } },
      { type: "heading", config: { text: "Recent activity" } },
      { type: "text",    config: { text: "🏅 Earned Explorer — 2d ago\n🎁 Claimed coffee perk — 5d ago" } },
    ],
  },
  {
    id: "quick-support",
    name: "Quick Support Page",
    tagline: "Accept support in under a minute.",
    emoji: "💝",
    category: "starter",
    theme: t({ background: "sunset", font: "outfit", buttonShape: "pill", buttonStyle: "gradient", accentHue: 18 }),
    blocks: [
      { type: "avatar",  config: { name: "Riley Park", subtitle: "Filmmaker · @rileymakes" } },
      { type: "text",    config: { text: "Working on a short film about the city at night. Every bit helps." } },
      { type: "tip_jar", config: { title: "Support the project", currency: "XION", cta: "Send support", suggestedAmounts: [1, 5, 10] } },
      { type: "image",   config: { url: QR_DEMO, alt: "Scan to support" } },
      { type: "heading", config: { text: "Recent supporters" } },
      { type: "text",    config: { text: "Jess · Marco · Ana · 14 others this week" } },
      { type: "text",    config: { text: "📈 Status: 64% to this week's goal" } },
    ],
  },
  {
    id: "creator-hub",
    name: "Creator Support Hub",
    tagline: "Posts, perks, supporters and campaigns in one place.",
    emoji: "🎨",
    category: "starter",
    theme: t({ background: "aurora", font: "space-grotesk", buttonShape: "rounded", buttonStyle: "glass", accentHue: 280 }),
    blocks: [
      { type: "avatar",  config: { name: "Alice Nguyen", subtitle: "Creator · @aliceworks" } },
      { type: "text",    config: { text: "Designing tools for small teams. Drops every Friday." } },
      { type: "heading", config: { text: "Featured links" } },
      { type: "link",    config: { title: "Latest drop", url: "https://", emoji: "✨" } },
      { type: "link",    config: { title: "Behind the scenes", url: "https://", emoji: "🎟️" } },
      { type: "tip_jar", config: { title: "Back the next drop", currency: "XION", suggestedAmounts: [1, 5, 10] } },
      { type: "heading", config: { text: "Active campaign" } },
      { type: "text",    config: { text: "🚀 Spring identity drop · 1.2k joined" } },
      { type: "heading", config: { text: "Badge wall" } },
      { type: "text",    config: { text: "🏅 Founder · 🎨 Creator tier 2 · 🤝 Community" } },
    ],
  },
  {
    id: "athlete-passport",
    name: "Athlete Passport",
    tagline: "Stats, sponsors and event check-ins.",
    emoji: "🏃",
    category: "starter",
    theme: t({ background: "mint", font: "outfit", buttonShape: "rounded", buttonStyle: "solid", accentHue: 152 }),
    blocks: [
      { type: "avatar",  config: { name: "Jordan Kim", subtitle: "Marathon · Triathlon" } },
      { type: "text",    config: { text: "Training log + race calendar + recovery picks." } },
      { type: "heading", config: { text: "Active lifestyle badges" } },
      { type: "text",    config: { text: "🏅 Sub-3 marathon · 🥇 Top 100 IM 70.3 · 🌅 Sunrise Club" } },
      { type: "heading", config: { text: "Wellness offers" } },
      { type: "link",    config: { title: "10% off Sound District spa", url: "https://", emoji: "🧖" } },
      { type: "heading", config: { text: "Event check-ins" } },
      { type: "image",   config: { url: QR_DEMO, alt: "Scan for race day" } },
    ],
  },
  {
    id: "shopper-perks",
    name: "Shopper Perks Passport",
    tagline: "Personal offers from brands you like.",
    emoji: "🛍️",
    category: "starter",
    theme: t({ background: "sunset", font: "outfit", buttonShape: "rounded", buttonStyle: "glass", accentHue: 25 }),
    blocks: [
      { type: "avatar",  config: { name: "Sam Park", subtitle: "Shopper · @samshops" } },
      { type: "heading", config: { text: "Shopper badges" } },
      { type: "text",    config: { text: "🛍️ Frequent Buyer · 🌱 Sustainable Shopper · 🎟️ Drop Day" } },
      { type: "heading", config: { text: "Vouchers for you" } },
      { type: "link",    config: { title: "Free late checkout · Atlas Stays", url: "https://", emoji: "🏨" } },
      { type: "link",    config: { title: "Pre-launch · Lumen Apparel", url: "https://", emoji: "🧥" } },
      { type: "heading", config: { text: "Reward locker" } },
      { type: "link",    config: { title: "Signed sticker pack", url: "https://", emoji: "🎁" } },
    ],
  },
  {
    id: "community-leader",
    name: "Community Leader Page",
    tagline: "Member directory, events, and supporters.",
    emoji: "🤝",
    category: "starter",
    theme: t({ background: "lavender", font: "space-grotesk", buttonShape: "soft", buttonStyle: "gradient", accentHue: 270 }),
    blocks: [
      { type: "avatar",  config: { name: "Aurora Collective", subtitle: "Hosted by Léa & friends" } },
      { type: "text",    config: { text: "1,200+ members. Monthly meetups. Quarterly drops." } },
      { type: "heading", config: { text: "Community badges" } },
      { type: "text",    config: { text: "🤝 Founding member · 📣 Host · 🌱 Mentor" } },
      { type: "heading", config: { text: "Active campaigns" } },
      { type: "link",    config: { title: "Join Spring drop", url: "https://", emoji: "🚀" } },
      { type: "tip_jar", config: { title: "Support the collective", currency: "XION", suggestedAmounts: [5, 10, 25] } },
      { type: "heading", config: { text: "Event rewards" } },
      { type: "link",    config: { title: "Free ticket for members", url: "https://", emoji: "🎟️" } },
    ],
  },
  {
    id: "fundraise-starter",
    name: "Fundraise Campaign Starter",
    tagline: "Goal, supporters, and progress at a glance.",
    emoji: "🚀",
    category: "starter",
    ...
    blocks: [
      ...
      { type: "avatar",  config: { name: "Project Spring", subtitle: "Goal · 10,000 XION" } },
      { type: "text",    config: { text: "We're raising support to ship a free pass for 1,000 new members." } },
      { type: "text",    config: { text: "📊 Progress: 6,420 / 10,000 (64%)" } },
      { type: "heading", config: { text: "Support tiers" } },
      { type: "link",    config: { title: "Cheer · 1 XION", url: "https://", emoji: "👏" } },
      { type: "link",    config: { title: "Backer · 10 XION", url: "https://", emoji: "💎" } },
      { type: "link",    config: { title: "Champion · 50 XION", url: "https://", emoji: "🏆" } },
      { type: "tip_jar", config: { title: "Back the campaign", currency: "XION", suggestedAmounts: [1, 10, 50] } },
      { type: "image",   config: { url: QR_DEMO, alt: "Scan to back" } },
      { type: "heading", config: { text: "Recent activity" } },
      { type: "text",    config: { text: "Marco backed at Backer · 5m ago\nJess cheered · 12m ago" } },
    ],
  },
  {
    id: "local-business-rewards",
    name: "Local Business Rewards Page",
    tagline: "Brand offers, claim rewards, visitor QR, community proof.",
    emoji: "🏪",
    category: "starter",
    ...
    blocks: [
      ...
      { type: "heading", config: { text: "Today's offers" } },
      { type: "link",    config: { title: "20% off any drink", url: "https://", emoji: "☕" } },
      { type: "link",    config: { title: "Free pastry on 5th visit", url: "https://", emoji: "🥐" } },
      { type: "heading", config: { text: "Claim rewards" } },
      { type: "link",    config: { title: "View reward locker", url: "https://", emoji: "🎁" } },
      { type: "heading", config: { text: "Visitor check-in" } },
      { type: "image",   config: { url: QR_DEMO, alt: "Scan in store" } },
      { type: "heading", config: { text: "Community proof" } },
      { type: "text",    config: { text: "⭐ 4.9 from 1.2k visitors · 230 active members" } },
    ],
  },
